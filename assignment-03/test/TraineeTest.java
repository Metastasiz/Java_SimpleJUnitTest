...
public class TraineeTest {
    ...
    public void allTest(){
        ...
        Assert.assertEquals((int)DAYS.between(date, today),e11.getDurationEmDay());
        //
        Assert.assertTrue(e11.emShorter(e11.getDurationEmDay()+2));
        Assert.assertTrue(e11.emLonger(e11.getDurationEmDay()-2));
    }
